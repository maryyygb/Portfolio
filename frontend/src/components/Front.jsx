  ...
  return (
    <div className="hero z-20 front-bg flex items-center h-screen w-full p-5 sm:p-25 lg:pl-35">
      ...
      <div className="flex flex-col gap-2 pt-8 md:pt-28 lg:pt-36 z-40 px-2 sm:px-0">
        ...
        <h1 className="role text-5xl font-bold sm:text-6xl lg:text-8xl xl:text-11xl lg:w-[70%] w-[90%] text-orange-50">
        ...
        <div className="normal-t text-orange-950 text-sm flex flex-row gap-2 sm:gap-5 sm:text-2xl sm:mt-6 mt-4">
          <a
            href=""
            className="or-grad text-xs px-4 py-2 bg-amber-500 rounded-full font-bold border-solid border-1 border-slate-500/80 border-dark sm:px-14 sm:py-4 sm:text-md lg:text-xl font-medium flex items-center gap-2 hover:cursor-pointer hover:shadow-[0_0_10px_3px] hover:shadow-orange-700 hover:text-orange-900"
          >
            See My Work <TfiArrowRight />
          </a>
          <a
            href=""
            className="text-xs px-4 py-2 sm:px-14 sm:py-4 sm:text-md lg:text-xl text-orange-50/80 rounded-full border-solid border-1 border-orange-50/25 z-40 flex gap-2 font-bold items-center hover:cursor-pointer hover:shadow-[0_0_10px_2px] hover:shadow-slate-500 hover:text-orange-50"
          >
