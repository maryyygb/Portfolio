  ...
  return (
    <div className="w-screen/10 bg-[#221209] relative pb-16 md:pb-22 border-1 border-b-orange-500/60 overflow-hidden">
      ...
      <div className="flex flex-col justify-center">
        <div className="grid gap-10 xl:grid-cols-2 lg:gap-10 md:gap-12 justify-center items-center px-10 m-auto sm:px-16">
          <div className="photo-card px-6 xl:px-0 rounded">
            <img
              src={myPicture}
              alt="My Picture"
              className="h-[25vh] rounded-xl lg:h-[30vh] xl:h-[60vh] w-auto lg:rounded-2xl border-1 border-orange-500/80 shadow-lg m-auto"
            />
          </div>
